...
cmds = [
    ...
    "python main.py -d /media/hkuit155/NewDisk/imagenet -dset imagenet -a resdg50 -lr 0.05 --weight-decay 4e-5 --epochs 200 --gpu-id 0 --den-target 0.5 --pretrained pytorch --lr-mode cosine --batch-size 256 --checkpoint imagenet_resnet50/DPACS_full_50_g1 --group_size 1",
    "python main.py -d /media/hkuit155/NewDisk/imagenet -dset imagenet -a resdg50 -lr 0.05 --weight-decay 4e-5 --epochs 200 --gpu-id 0 --den-target 0.5 --pretrained pytorch --lr-mode cosine --batch-size 256 --checkpoint imagenet_resnet50/DPACS_full_50_g1_dual --group_size 1 --dual_fc",
    ...
    "python main.py -d /media/hkuit155/NewDisk/imagenet -dset imagenet -a mobilenet_v2_dg -lr 0.05 --weight-decay 4e-5 --epochs 200 --gpu-id 0 --den-target 0.5 --pretrained pytorch --lr-mode cosine --batch-size 256 --checkpoint imagenet_mobile/DPACS_full_50_g1 --group_size 1",
    "python main.py -d /media/hkuit155/NewDisk/imagenet -dset imagenet -a mobilenet_v2_dg -lr 0.05 --weight-decay 4e-5 --epochs 200 --gpu-id 0 --den-target 0.5 --pretrained pytorch --lr-mode cosine --batch-size 256 --checkpoint imagenet_mobile/DPACS_full_50_g1_dual --group_size 1 --dual_fc",
]
